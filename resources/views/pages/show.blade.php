            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <article class="post">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                ...
                                <h1 class="entry-title"><a href="{{route('post.show', $post->slug)}}">{{$post->tile}}</a></h1>
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{$post->author->getImage()}}" class="pull-left img-circle" alt="" style="width: 100px; height: 100px;">
